...
commands = [Command('help', 'help', 'Sends a list of all commands.'),
            ...
            Command('welcome', 'setup welcome',
                    'Page to set up the welcome system.', admin_only=True, in_help=False),
            ...
            Command('roles', 'setup roles',
                    'Page to set up the roles.', admin_only=True, in_help=False),
            ...
            Command('moderation', 'setup moderation',
                    'Page to set up the moderation.', admin_only=True, in_help=False),
            Command('moderation log', 'setup moderation log <text-channel>',
                    'Set the moderation log.', admin_only=True, in_help=False),
